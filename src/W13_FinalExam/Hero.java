...
public class Hero {
    ...
    public Hero(String name, String attack_msg, float HP, float currentHP, float MP, float currentMP, float damage, float armor, float ultimate_cost, float ultimate_damage) {
        this.name = name;
    ...
    boolean ultimate(){
        if(currentMP >= ultimate_cost){
            ...
            currentMP = currentMP - ultimate_cost;
            return true;
        }
     return false;
    }
